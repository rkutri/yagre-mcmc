...
config = {'T': 10., 'alpha' : 0.8, 'gamma' : 0.4, 'N' : 10, 'P' : 2}
design = [uniform(0.5, 1.5, 2) for _ in range(config['N'])]
...
data = setup.generate_synthetic_data(truePar, solver, dataNoiseVar)
